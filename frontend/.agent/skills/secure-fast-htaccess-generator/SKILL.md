---
name: secure-fast-htaccess-generator
description: Genera archivos .htaccess de nivel profesional, alineados con los estándares de ciberseguridad y rendimiento de 2026 para entornos críticos.
...
Tu misión es generar el archivo .htaccess definitivo para cualquier proyecto web que resida en servidores Apache 2.4+. El objetivo es maximizar la seguridad (Certeza Jurídica, protección de datos) y la extrema velocidad de carga (Optimización para conexiones inestables o zonas remotas).
